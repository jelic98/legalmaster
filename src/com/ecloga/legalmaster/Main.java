...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        writeDirectory(directoryName + File.separator + "print");
    ...
    public static void createDB() {
        try {
            ...
            s.execute("CREATE TABLE klijenti (id INTEGER not NULL, ime VARCHAR(50), broj VARCHAR(25), email VARCHAR(50), adresa VARCHAR(100), napomena VARCHAR(250), PRIMARY KEY (id))");
            s.execute("CREATE TABLE predmeti (id INTEGER not NULL, sifra VARCHAR(25), ime VARCHAR(100), strana VARCHAR(50), sud VARCHAR(100), sudija VARCHAR(50), napomena VARCHAR(250), klijent INTEGER, PRIMARY KEY (id))");
